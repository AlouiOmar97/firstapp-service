...
export class ResidencesComponent {
  ...
  residencesList: Residence[]=[ 
    ...
    {id: 2, name: "Residence 2", address: "Address 2", image:"image 1"}, 
  ...
  countAppart(){
    this.nbAppart = this.appartService.getSameValueOf(this.appartementsList,"numEtage",8)
  }
  countResidence(){
    this.nbResidence = this.appartService.getSameValueOf(this.residencesList,"image","image 1")
  }
